...
import controller.popup.order.FoodItemController;
import controller.popup.order.OrderItemController;
...
import view.popup.ToppingPopupView;
...
public class OrderPopupController {
    ...
    public void edit(EditOrderPopupView view, Order order, SuccessCallback sc, ErrorCallback ec) {
        ...
        if (!order.getEmployee().equals(employee) && order.getEmployee().getPermission().compare(employee.getPermission()) > 0) {
